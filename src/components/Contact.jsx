const Contact = () => {
    return (
        <section
            className="relative min-h-screen w-full flex items-center justify-center px-4 sm:px-6 py-16 sm:py-20 animate-fade-in"
            style={{
            ...
            <div className="relative z-10 w-full max-w-[1200px]">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
                    ...
                    <article className="group rounded-xl bg-white/5 backdrop-blur-sm ring-1 ring-white/10 hover:ring-lime-300/40 transition-shadow shadow-lg hover:shadow-[0_0_30px_rgba(127,90,240,0.25)]">
                        <div className="p-6 flex flex-col h-full">
                            <div className="flex items-center gap-3">
                                <img src="/discord.png" alt="Discord" className="w-8 h-8 shrink-0 opacity-90 bg-lime-300 rounded-lg p-1" />
                            ...
                            <div className="mt-auto pt-6">
                                <a
                                    ...
                                    className="inline-flex items-center justify-center gap-2 w-full rounded-lg bg-lime-400/20 text-lime-200 px-4 py-2 text-sm font-semibold hover:bg-lime-400/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-lime-300 active:scale-[0.98]"
                                >
                    ...
                    <article className="group rounded-xl bg-white/5 backdrop-blur-sm ring-1 ring-white/10 hover:ring-lime-300/40 transition-shadow shadow-lg hover:shadow-[0_0_30px_rgba(127,90,240,0.25)]">
                        <div className="p-6 flex flex-col h-full">
                            <div className="flex items-center gap-3">
                                <img src="/email.png" alt="Email" className="w-8 h-8 shrink-0 opacity-90 bg-lime-300 rounded-lg p-1" />
                    ...
                    <article className="group rounded-xl bg-white/5 backdrop-blur-sm ring-1 ring-white/10 hover:ring-lime-300/40 transition-shadow shadow-lg hover:shadow-[0_0_30px_rgba(127,90,240,0.25)]">
                        <div className="p-6 flex flex-col h-full">
                            <div className="flex items-center gap-3">
                                <img src="/linkedin.png" alt="LinkedIn" className="w-8 h-8 shrink-0 opacity-90 bg-lime-300 rounded-lg p-1" />
                            ...
                            <div className="mt-auto pt-6">
                                <a
                                    ...
                                    className="inline-flex items-center justify-center gap-2 w-full rounded-lg bg-lime-400/20 text-lime-200 px-4 py-2 text-sm font-semibold hover:bg-lime-400/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-lime-300 active:scale-[0.98]"
                                >
                                    View LinkedIn<span aria-hidden>↗</span>
                                </a>
                            </div>
                        </div>
                    </article>
                ...
                <p className="mt-8 text-center text-lime-100/70 text-xs sm:text-sm">
